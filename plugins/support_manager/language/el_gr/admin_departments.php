...
$lang['AdminDepartments.index.confirm_delete'] = 'Τμήματα στα οποία έχουν εκχωρηθεί αιτήματα δεν μπορούν να διαγραφούν έως ότου όλα τα αιτήματα εκ νέου εκχωρηθούν σε ένα άλλο τμήμα. Είστε σίγουροι ότι θέλετε να διαγράψετε αυτό το τμήμα;';
...
$lang['AdminDepartments.!tooltip.close_ticket_interval'] = 'Όλα τα αιτήματα με κατάσταση διαφορετική από %1$s, των οποίων η τελευταία απάντηση προέρχεται από μέλος του προσωπικού, θα κλείσουν αυτόματα εάν δεν έχει δοθεί καμία απάντηση εντός του επιλεγμένου χρονικού διαστήματος.';
$lang['AdminDepartments.!tooltip.delete_ticket_interval'] = 'Όλα τα αιτήματα με κατάσταση %1$s θα διαγραφούν αυτόματα αφού παραμείνουν σε αυτή την κατάσταση για το επιλεγμένο χρονικό διάστημα.';
$lang['AdminDepartments.!tooltip.reminder_ticket_interval'] = 'Για όλα τα αιτήματα με κατάσταση διαφορετική από %1$s, θα σταλεί μια υπενθύμιση στο άλλο μέρος εάν δεν έχει δοθεί απάντηση εντός του επιλεγμένου χρονικού διαστήματος.';
$lang['AdminDepartments.!tooltip.send_ticket_received'] = 'Η απενεργοποίηση αυτού του πλαισίου υποδεικνύει ότι τα νέα αιτήματα που δημιουργούνται για αυτό το τμήμα (μέσω email ή πελάτη) δεν θα στέλνουν ειδοποίηση απάντησης στον πελάτη ή το προσωπικό μέσω του email Ticket Received ή του email Staff Ticket Updated, αντίστοιχα.';
$lang['AdminDepartments.!tooltip.automatic_transition'] = 'Αλλάζει την κατάσταση σε %1$s όταν ένα μέλος του προσωπικού απαντά.';
$lang['AdminDepartments.!tooltip.include_attachments'] = 'Οι διακομιστές αλληλογραφίας έχουν περιορισμούς όσον αφορά τα μεγέθη συνημμένων και τους τύπους αρχείων. Για να μειώσετε τον κίνδυνο απόρριψης του ηλεκτρονικού ταχυδρομείου, παρακαλούμε να συμπεριλάβετε τους περιορισμούς τύπου και μεγέθους συνημμένων αρχείων. Για να βεβαιωθείτε ότι ο πελάτης γνωρίζει τα συνημμένα που δεν συμπεριλήφθηκαν, χρησιμοποιήστε την ετικέτα {ticket.reply_has_attachments} στις ειδοποιήσεις των αιτημάτων.';
...
$lang['AdminDepartments.!tooltip.auto_delete'] = 'Εάν το αίτημα κλείσει, τα δεδομένα του πεδίου θα διαγραφούν αυτόματα. Τα δεδομένα δεν θα είναι πλέον ορατά στο προσωπικό.';
...
$lang['AdminDepartments.add.field_clients_only'] = 'Επιτρέψτε μόνο σε πελάτες να ανοίγουν ή να απαντούν σε αιτήματα';
...
$lang['AdminDepartments.add.field_send_ticket_received'] = 'Αποστολή μηνυμάτων ηλεκτρονικού ταχυδρομείου αυτόματης απάντησης για νέα αιτήματα';
$lang['AdminDepartments.add.field_automatic_transition'] = 'Αυτόματη μετάβαση στην κατάσταση του αιτήματος στην απάντηση του διαχειριστή';
...
$lang['AdminDepartments.add.field_include_attachments'] = 'Συμπεριλάβετε υποστηριζόμενα συνημμένα στις ειδοποιήσεις αιτημάτων';
...
$lang['AdminDepartments.add.field_close_ticket_interval'] = 'Αυτόματο κλείσιμο αιτημάτων';
$lang['AdminDepartments.add.field_delete_ticket_interval'] = 'Αυτόματη διαγραφή αιτημάτων';
$lang['AdminDepartments.add.field_reminder_ticket_interval'] = 'Αυτόματη αποστολή υπενθυμίσεων αιτημάτων';
$lang['AdminDepartments.add.field_reminder_ticket_status'] = 'Αποστολή υπενθυμίσεων σε αιτήματα με κατάσταση';
$lang['AdminDepartments.add.field_reminder_ticket_priority'] = 'Αποστολή υπενθυμίσεων σε αιτήματα με προτεραιότητα';
$lang['AdminDepartments.add.field_response_id'] = 'Αυτόματο κλείσιμο της απάντησης του αιτήματος';
...
$lang['AdminDepartments.edit.field_clients_only'] = 'Επιτρέψτε μόνο σε πελάτες να ανοίγουν ή να απαντούν σε αιτήματα';
...
$lang['AdminDepartments.edit.field_send_ticket_received'] = 'Αποστολή μηνυμάτων ηλεκτρονικού ταχυδρομείου αυτόματης απάντησης για νέα αιτήματα';
$lang['AdminDepartments.edit.field_automatic_transition'] = 'Αυτόματη μετάβαση στην κατάσταση του αιτήματος στην απάντηση του διαχειριστή';
...
$lang['AdminDepartments.edit.field_include_attachments'] = 'Συμπεριλάβετε υποστηριζόμενα συνημμένα στις ειδοποιήσεις αιτημάτων';
...
$lang['AdminDepartments.edit.field_close_ticket_interval'] = 'Αυτόματο κλείσιμο αιτημάτων';
$lang['AdminDepartments.edit.field_delete_ticket_interval'] = 'Αυτόματη διαγραφή αιτημάτων';
$lang['AdminDepartments.edit.field_reminder_ticket_interval'] = 'Αυτόματη αποστολή υπενθυμίσεων αιτημάτων';
$lang['AdminDepartments.edit.field_reminder_ticket_status'] = 'Αποστολή υπενθυμίσεων σε αιτήματα με κατάσταση';
$lang['AdminDepartments.edit.field_reminder_ticket_priority'] = 'Αποστολή υπενθυμίσεων σε αιτήματα με προτεραιότητα';
$lang['AdminDepartments.edit.field_response_id'] = 'Αυτόματο κλείσιμο της απάντησης του αιτήματος';
